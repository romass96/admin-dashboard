      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Всего отзывов</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{allFeedbacksCount}}</div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Положительных отзывов</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ positiveFeedbacksCount }}</div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Нормальных отзывов</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ normalFeedbacksCount }}</div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Негативных отзывов</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ negativeFeedbacksCount }}</div>
                </div>
              </div>
            </div>
            <div class="col-auto">
...
<div class="row">
        ...
        <div class="card-body">
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <b-form-select v-model="feedbackType" :options="feedbackTypes"/>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="categorySelect">Категория товара</label>
              <select class="form-control custom-select" id="categorySelect" v-model="feedbackProductCategory">
  ...
  <div class="col-md-9">
    ...
    <div class="card shadow mb-4" v-for="feedback in feedbacks" :key="feedback.id">
      <div class="card-body">
    ...
    <b-pagination v-if="feedbacks.length"
      v-model="currentPage"
...
export default {
  ...
  computed: {
    ...mapGetters([
      'allFeedbacks', 'allCategories', 'totalFeedbackCount',
      'negativeFeedbacksCount', 'positiveFeedbacksCount', 'normalFeedbacksCount', 'allFeedbacksCount'])
  },
  methods: {
    ...
    getRatings(feedbackType) {
      ...
      setFiltersFromRoute(route) {
        ...
        if (period === 'today') {
          ...
          this.dateFrom = moment().subtract(1, 'months').format(DATE_PICKER_FORMAT);
        }
      }
  }
}
